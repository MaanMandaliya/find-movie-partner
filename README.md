...
```
cd existing_repo
git remote add origin https://git.cs.dal.ca/mmandaliya/movie-partner.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cs.dal.ca/mmandaliya/movie-partner/-/settings/integrations)
